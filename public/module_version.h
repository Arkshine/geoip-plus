 ...
 */
...
#if defined EXTENSION_GENERATED_BUILD
	#if defined RC_COMPILE
		#undef EXTENSION_USE_VERSIONLIB
	#endif
	...
	#define EXTENSION_VERSION_FILE     1,3,0,0
#endif

#define EXTENSION_BUILD_TIMESTAMP  __DATE__ " " __TIME__

#if !defined(EXTENSION_GENERATED_BUILD) || !defined(EXTENSION_USE_VERSIONLIB)
